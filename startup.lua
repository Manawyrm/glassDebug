...
function renderBuffer()
	...
	if (#ScreenBuffer > 0) then
		glasses.addBox(Configuration.LeftOffset - 5, Configuration.TopOffset - 5, Configuration.Width , (10 * #ScreenBuffer) + 7, Configuration.BackgroundColor, Configuration.BackgroundOpacity)
	end
...
function waitForRedNetData()
	writeText("testtest", 0xFF0000, 1000)
	while true do
